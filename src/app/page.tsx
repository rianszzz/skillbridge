...
export default function Home() {
  return <main id="main">
    <section className="hero"><div><p className="eyebrow">Bukti lebih kuat dari klaim</p><h1>Ukur kesiapan. Tunjukkan buktinya.</h1><p className="lede">Skillbridge membaca karya nyata, menilainya dengan rubrik transparan, lalu menunjukkan gap yang layak dikerjakan berikutnya.</p><div className="actions"><Link className="button" href="/assess">Mulai penilaian</Link><a className="button secondary" href="#cara-kerja">Lihat cara kerja</a></div></div>
      <div className="ledger" aria-label="Alur Skillbridge"><article data-step="1"><strong>Bukti</strong><p className="hint">Kode GitHub, gambar desain, atau PDF laporan.</p></article><article data-step="2"><strong>Rubrik</strong><p className="hint">4 kriteria standar industri sesuai bidang pilihan.</p></article><article data-step="3"><strong>Langkah berikutnya</strong><p className="hint">Peta gap skill, materi terarah, dan simulasi wawancara.</p></article></div></section>
